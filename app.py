...
Hd_huanbaobiao = ".\\file\\Hd全环保标模版.pdf"
...
@app.route('/print_Hd_huanbaobiao')
def print_Hd_huanbaobiao():
    verify()
    global temp_print_file_path, Hd_huanbaobiao
    if not os.path.exists(temp_print_file_path):
        return '请选择文件'
    if temp_print_file_path[-7:-4] == '已打印':
        return '请勿重复点击'
    ...
    if not os.path.exists(temp_print_file_path[:-4] + '_已打印.pdf'):
        with open(temp_print_file_path[:-4] + '_已打印.pdf', 'w') as f:
            pass
    merge_pdfs_vertically(Hd_huanbaobiao, temp_print_file_path, temp_print_file_path[:-4] + '_已打印.pdf')
...
@app.route('/craft_Hd_huanbaobiao')
def craft_Hd_huanbaobiao():
    verify()
    global temp_print_file_path, Hd_huanbaobiao
    if not os.path.exists(temp_print_file_path):
        return '请选择文件'
    ...
    if not os.path.exists(temp_print_file_path[:-4] + '_带环保标.pdf'):
        with open(temp_print_file_path[:-4] + '_带环保标.pdf', 'w') as f:
            pass
    merge_pdfs_vertically(Hd_huanbaobiao, temp_print_file_path, temp_print_file_path[:-4] + '_带环保标.pdf')

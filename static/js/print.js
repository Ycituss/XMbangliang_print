...
function print_KDPOTATO5() {
    fetch('/print_KDPOTATO5')
    .then(response => response.text())
    .then(data => {
        document.getElementById('printNum').placeholder = '已打印，请重新输入数量'
        document.getElementById('printNum').value = ''
...
function print_SHEIN_huanbaobiao() {
    document.getElementById('fileTypeMT').innerText = '正在合成，请勿重复点击'
    fetch('/print_SHEIN_huanbaobiao')
   .then(response => response.text())
   .then(data => {
        document.getElementById('fileTypeMT').innerText = data.split('|')[0]
        if(data.split('|').length > 1) {
...
function print_YLCX_huanbaobiao() {
    document.getElementById('fileTypeMT').innerText = '正在合成，请勿重复点击'
    fetch('/print_YLCX_huanbaobiao')
   .then(response => response.text())
   .then(data => {
        document.getElementById('fileTypeMT').innerText = data.split('|')[0]
        if(data.split('|').length > 1) {
...
function print_YZ_huanbaobiao() {
    document.getElementById('fileTypeMT').innerText = '正在合成，请勿重复点击'
    fetch('/print_YZ_huanbaobiao')
   .then(response => response.text())
   .then(data => {
        document.getElementById('fileTypeMT').innerText = data.split('|')[0]
        if(data.split('|').length > 1) {
...
function print_LY_huanbaobiao() {
    document.getElementById('fileTypeMT').innerText = '正在合成，请勿重复点击';
    fetch('/print_LY_huanbaobiao')
       .then(response => response.text())
       .then(data => {
            document.getElementById('fileTypeMT').innerText = data.split('|')[0];
            if (data.split('|').length > 1) {
...
function print_PP_huanbaobiao() {
    document.getElementById('fileTypeMT').innerText = '正在合成，请勿重复点击'
    fetch('/print_PP_huanbaobiao')
   .then(response => response.text())
   .then(data => {
        document.getElementById('fileTypeMT').innerText = data.split('|')[0]
        if(data.split('|').length > 1) {
...
function print_MH_huanbaobiao() {
    document.getElementById('fileTypeMT').innerText = '正在合成，请勿重复点击'
    fetch('/print_MH_huanbaobiao')
   .then(response => response.text())
   .then(data => {
        document.getElementById('fileTypeMT').innerText = data.split('|')[0]
        if(data.split('|').length > 1) {
...
function print_BL_huanbaobiao() {
    document.getElementById('fileTypeMT').innerText = '正在合成，请勿重复点击'
    fetch('/print_BL_huanbaobiao')
   .then(response => response.text())
   .then(data => {
        document.getElementById('fileTypeMT').innerText = data.split('|')[0]
        if(data.split('|').length > 1) {
...
function print_Ssr_huanbaobiao() {
    document.getElementById('fileTypeMT').innerText = '正在合成，请勿重复点击'
    fetch('/print_Ssr_huanbaobiao')
   .then(response => response.text())
   .then(data => {
        document.getElementById('fileTypeMT').innerText = data.split('|')[0]
        if(data.split('|').length > 1) {
...
function print_Hd_huanbaobiao() {
    document.getElementById('fileTypeMT').innerText = '正在合成，请勿重复点击'
    fetch('/print_Hd_huanbaobiao')
   .then(response => response.text())
   .then(data => {
        document.getElementById('fileTypeMT').innerText = data.split('|')[0]
        if(data.split('|').length > 1) {
...
function print_XD_huanbaobiao() {
    document.getElementById('fileTypeMT').innerText = '正在合成，请勿重复点击'
    fetch('/print_XD_huanbaobiao')
   .then(response => response.text())
   .then(data => {
        document.getElementById('fileTypeMT').innerText = data.split('|')[0]
        if(data.split('|').length > 1) {
...
function print_XGuo_huanbaobiao() {
    document.getElementById('fileTypeMT').innerText = '正在合成，请勿重复点击'
    fetch('/print_XGuo_huanbaobiao')
   .then(response => response.text())
   .then(data => {
        document.getElementById('fileTypeMT').innerText = data.split('|')[0]
        if(data.split('|').length > 1) {
...
function craft_Ssr_huanbaobiao() {
    document.getElementById('fileTypeMT').innerText = '合成完成';
    const link = document.createElement('a');
    link.href = '/craft_Ssr_huanbaobiao';
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
}

function craft_Hd_huanbaobiao() {
    document.getElementById('fileTypeMT').innerText = '合成完成';
    const link = document.createElement('a');
    link.href = '/craft_Hd_huanbaobiao';
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
}
...
function craft_XF_huanbaobiao() {
    document.getElementById('fileTypeMT').innerText = '合成完成';
    const link = document.createElement('a');
    link.href = '/craft_XF_huanbaobiao';
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
}

function craft_XGuo_huanbaobiao() {
    document.getElementById('fileTypeMT').innerText = '合成完成';
    const link = document.createElement('a');
    link.href = '/craft_XGuo_huanbaobiao';
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
}
...
function craft_BLGH_huanbaobiao() {
    document.getElementById('fileTypeMT').innerText = '合成完成';
    const link = document.createElement('a');
    link.href = '/craft_BLGH_huanbaobiao';
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
}
